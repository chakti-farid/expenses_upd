...
public class CategoriesController implements Serializable {
    ...
    @EJB
    private importDb.CategoriesFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/familyBundle").getString("CategoriesCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/familyBundle").getString("CategoriesUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/familyBundle").getString("CategoriesDeleted"));
        if (!JsfUtil.isValidationFailed()) {
