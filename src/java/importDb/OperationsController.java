...
public class OperationsController implements Serializable {
    ...
    @EJB
    private importDb.OperationsFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/familyBundle").getString("OperationsCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/familyBundle").getString("OperationsUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/familyBundle").getString("OperationsDeleted"));
        if (!JsfUtil.isValidationFailed()) {
